...
def validator_only_letters_and_spaces(value):
    for char in value:
...
class Customer(models.Model):
    name = models.CharField(
        ...
        validators=[
            # validate_name,
            validator_only_letters_and_spaces
        ]
    )
    ...
    email = models.EmailField(
        error_messages={'invalid': "Enter a valid email address"}  # django error with customised msg
    )
