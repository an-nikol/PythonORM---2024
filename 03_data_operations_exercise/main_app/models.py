...
class HotelRoom(models.Model):
    ...
    room_type = models.CharField(max_length=10, choices=CHOICE_ROOM)
...
# Task 07.
class CharacterChoicesClassNames(models.TextChoices):
    MAGE = 'Mage', 'Mage'
    WARRIOR = 'Warrior', 'Warrior'
    ASSASSIN = 'ASSASIN', 'ASSASIN'
    SCOUT = 'SCOUT', 'SCOUT'


class Character(models.Model):
    name = models.CharField(max_length=100)
    class_name = models.CharField(max_length=20, choices=CharacterChoicesClassNames.choices)
